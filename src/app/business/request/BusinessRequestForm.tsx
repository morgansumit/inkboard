        ...
        <form onSubmit={handleSubmit} className="business-request-form" data-admin-editable="true">
            ...
            <div className="form-group" data-admin-editable="true">
                ...
                <textarea
                    ...
                    placeholder="Tell us about your audience, campaign goals, and how you plan to use centsably ads."
                    rows={5}
                    required
                    disabled={isPending || isApproved || submitting}
                />
            ...
            <div className="form-footer">
                ...
                <p className="form-legal">We review every request to keep centsably spam-free. By submitting, you agree to our Ads Terms.</p>
            </div>
