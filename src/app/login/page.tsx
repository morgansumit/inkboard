...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (error) {
            ...
            // Hard redirect so the server layout re-runs with fresh session cookies
        ...
        <div className="auth-page-outer" style={{ minHeight: '100vh', background: 'var(--color-bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
            <div style={{ width: '100%', maxWidth: '400px' }}>
                ...
                <a 
                    ...
                    style={{ width: '100%', marginBottom: '20px', gap: '10px', textDecoration: 'none', display: 'flex', justifyContent: 'center', alignItems: 'center' }}
                >
